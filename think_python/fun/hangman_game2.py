...
def lives_left(guesses_left, display_word, word, guessed_letters):
    ...
    print(f"""
       ...
       \n{guesses_left} lives left remaining.
        """)
    if display_word == word or guesses_left <= 0:
        exit()
    elif guesses_left > 0:
...
def get_word():
    print("Welcome to the Hangman 2 Game!")
